    ...
    useEffect(() => {
        const fetchTags = async () => {
            try {
                ...
                console.error("태그를 가져오는 중 오류가 발생했습니다.", error);
            }
        };
        fetchTags();
    }, []);
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-800 bg-opacity-75">
            <div id="default-modal" className="relative p-4 w-full max-w-md max-h-full overflow-y-auto">
                ...
                <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        <svg className="" width="120" zoomAndPan="magnify"
                            viewBox="0 0 224.87999 89.999999"
                            preserveAspectRatio="xMidYMid meet" version="1.0">
                            <defs><g />
                                <clipPath id="1862d06f4c"><path d="M 0 0.0234375 
                            L 224.761719 0.0234375 L 224.761719 89.976562 L 0 89.976562 Z M 0 0.0234375 "
                                    clipRule="nonzero" /></clipPath><clipPath id="7cd468f544">
                                    <path d="M 48.789062 21.6875 L 57.785156 21.6875 L 57.785156 31.433594 
                                L 48.789062 31.433594 Z M 48.789062 21.6875 " clipRule="nonzero" />
                                </clipPath><clipPath id="97c7ba3732">
                                    <path d="M 183.464844 23.207031 L 190.960938 23.207031 L 190.960938 
                                30.703125 L 183.464844 30.703125 Z M 183.464844 23.207031
                                " clipRule="nonzero" /></clipPath>
                            </defs><g clip-path="url(#1862d06f4c)">
                                <path fill="#ffffff" d="M 0 0.0234375 L 224.878906 0.0234375 
                            L 224.878906 89.976562 L 0 89.976562 Z M 0 0.0234375 "
                                    fill-opacity="1" fill-rule="nonzero" />
                                <path fill="#ffffff" d="M 0 0.0234375 L 224.878906 0.0234375 L 224.878906 
                            89.976562 L 0 89.976562 Z M 0 0.0234375 " fill-opacity="1" fill-rule="nonzero" />
                            </g><g fill="#5271ff" fill-opacity="1"><g transform="translate(14.048348, 60.582478)">
                                <g><path d="M 23.53125 -8.015625 C 24.882812 -8.015625 26.195312 -8.21875 
                            ...
                            -29.859375 C 16.082031 -29.171875 14.738281 -28.257812 13.75 -27.125 C 12.757812
                                ...
                                19.414062 -8.015625 23.53125 -8.015625 Z M 23.53125 -8.015625 " /></g></g></g>
                            <g fill="#5271ff" fill-opacity="1"><g transform="translate(45.884446, 60.582478)">
                                <g><path d="M 3.625 -37.6875 C 4.601562 -38.664062 5.769531 -39.15625 7.125 -39.15625 C 8.476562 
                                ...
                                -37.6875 Z M 2.828125 -24.203125 L 2.828125 0 L 11.1875 0 L 11.1875 -24.203125 Z M 2.828125 -24.203125 " />
                                    ...
                                    -12.984375 11.1875 -12.734375 L 11.1875 0 Z M 2.828125 0 " /></g></g>
                            </g><g fill="#5271ff" fill-opacity="1"><g transform="translate(76.258438, 60.582478)"><g><path d="M 15.703125 
                    ...
                    <div className="p-4 md:p-5">
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            ...
                            <div>
                                ...
                                <div className="flex justify-evenly">
                                    <div className="flex items-center">
                                        ...
                                        />
                                        <label htmlFor="user-role" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">유저</label>
                                    </div>
                                    <div className="ml-5 flex items-center">
                                        <input
                                            ...
                                            value="Instructor"
                                            name="role"
                                            checked={userInfo.role === "Instructor"}
                                            onChange={handleRoleChange}
                                            className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                        />
                                        <label htmlFor="instructor-role" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">강사</label>
                                    </div>
                                    <div className="ml-5 flex items-center">
                                        <input
                                            id="instructor-role"
                                            ...
                                            className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                        />
                                        <label htmlFor="instructor-role" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">관리자</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* 비밀번호 확인 */}
                            <div>
                                <label htmlFor="password-check" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                    비밀번호 확인
                                </label>
                                <input
                                    type="password"
                            ...
                            {/* 연락용 전화번호 */}
                            <div>
                                <label htmlFor="contact-tel" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                    연락용 전화번호
                                </label>
                                <input
                                    type="tel"
                            ...
                            {/* 선호 태그 */}
                            <div>
                                <label htmlFor="tags" className="title text-center block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                    선호강의 태그
                                </label>
                                <ul className="grid mx-auto grid-cols-3 gap-2 text-sm font-medium text-gray-900 bg-white rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                    {allTags.map((tag) => (
