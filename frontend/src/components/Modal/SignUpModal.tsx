            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                                    focus:outline-blue-600 block w-full p-2.5 "
              ...
              <div>
                ...
                <input
                  ...
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:outline-blue-600"
                  required
                />
              </div>
                ...
                <div className="flex justify-evenly">
                  <div className="flex items-center">
                    <input
                      ...
                      className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded outline-none "
                    />
                    <label
                      htmlFor="user-role"
              ...
              <div>
                <label
                  htmlFor="tags"
                  className="title text-center block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                >
                  선호강의 태그
                </label>
