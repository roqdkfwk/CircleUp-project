    ...
    const handleSubmit = async (event: FormEvent) => { 
        ...
        try {
            if (checkPwd === userInfo.pw) {
                ...
                formData.append('contactTel', userInfo.contactTel);

                const numToTag: number[] = tagMapping(userInfo.tags);
                formData.append('tags', JSON.stringify(numToTag));

                const response = await updateMember(email, formData);
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        <div className="flex">
                            ...
                            <svg className="mx-auto" width="120" zoomAndPan="magnify"
                    ...
                    <div className="p-4 md:p-5">
                        <form className="space-y-4" action="#">
                            ...
                            <div>
                                <label htmlFor="tell" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                    연락용 전화번호
                                </label>
                                <input
                                    type="tel"
